...
class Auth {
  ...
  async signIn(userData) {
    ...
    _Router.default.init(); // Redirection to about page for new users


    if (data.user.newUser == true) {
      // new user! -> go to about page
      (0, _Router.gotoRoute)('/about');
    } else {
...
exports.default = _default;
},{"gsap":"../node_modules/gsap/index.js"}],"views/pages/dashboard.js":[function(require,module,exports) {
"use strict";
...
class DashboardView {
  init() {
    ...
    _Utils.default.drawerAnim();
  }

  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), _App.default.apiBase, _Auth.default.currentUser.firstName, _Router.anchorRoute, () => (0, _Router.gotoRoute)('/trackerEntry'), () => (0, _Router.gotoRoute)('/tracker'), _Router.anchorRoute, _Router.anchorRoute, _Router.anchorRoute);
...
class SignInView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), _Router.anchorRoute, this.signInSubmitHandler);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
class UserAPI {
  ...
  async addSavedBlogs(blogId) {
    // validate
    if (!blogId) return; // fetch the json data

    const response = await fetch("".concat(_App.default.apiBase, "/user/addSavedBlogs"), {
      method: "PUT",
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken),
        "Content-Type": 'application/json'
    ...
    if (!response.ok) {
      ...
      throw new Error('Problem adding blog to saved list');
    } // convert response payload into json - store as data
...
class EditProfileView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.user == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.updateProfileSubmitHandler.bind(this), this.user.firstName, this.user.lastName, this.user.email, this.user.bio, this.user.avatar ? (0, _litHtml.html)(_templateObject4(), _App.default.apiBase, this.user.avatar) : (0, _litHtml.html)(_templateObject5()), (0, _moment.default)(_Auth.default.currentUser.updatedAt).format('MMMM Do YYYY, @ h:mm a')));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
class AboutView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, () => (0, _Router.gotoRoute)('/'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
...
exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../UserAPI":"UserAPI.js","../../Toast":"Toast.js"}],"BlogAPI.js":[function(require,module,exports) {
"use strict";
...
class BlogAPI {
  async newBlog(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/blog"), {
      method: 'POST',
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
...
var _default = new BlogAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/eatBlog.js":[function(require,module,exports) {
"use strict";
...
var _BlogAPI = _interopRequireDefault(require("./../../BlogAPI"));
...
class EatBlogView {
  ...
  async getBlogs() {
    try {
      this.blogs = await _BlogAPI.default.getBlogs();
...
var _default = new EatBlogView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../BlogAPI":"BlogAPI.js","../../Toast":"Toast.js"}],"views/pages/mindBlog.js":[function(require,module,exports) {
"use strict";
...
function _templateObject() {
  const data = _taggedTemplateLiteral(["\n      <va-app-header title=\"\" user=\"", "\"></va-app-header>\n      <div class=\"page-content\">\n        <h1>Mind</h1>\n        <p>Discover meditation and mindfulness techniques</p>\n        <div class=\"blog-grid calign\">\n          ", "\n\n        </div>\n      </div>      \n    "]);
...
class MindBlogView {
  async init() {
    ...
    await this.getBlogs();
    this.filterBlogs('category', 'mind');
  }
...
var _default = new MindBlogView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../BlogAPI":"BlogAPI.js","../../Toast":"Toast.js"}],"views/pages/moveBlog.js":[function(require,module,exports) {
"use strict";
...
var _default = new MoveBlogView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../BlogAPI":"BlogAPI.js","../../Toast":"Toast.js"}],"views/pages/savedList.js":[function(require,module,exports) {
"use strict";
...
class SavedListView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.savedBlogList == null ? (0, _litHtml.html)(_templateObject2()) : (0, _litHtml.html)(_templateObject3(), this.savedBlogList.map(blog => (0, _litHtml.html)(_templateObject4(), blog._id, blog.title, blog.post, blog.category, blog.media, JSON.stringify(blog.user)))));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new SavedListView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../Toast":"Toast.js","./../../UserAPI":"UserAPI.js"}],"TrackerAPI.js":[function(require,module,exports) {
"use strict";
...
class TrackerAPI {
  async newTrackerEntry(formData) {
    // send fetch request
    const response = await fetch("".concat(_App.default.apiBase, "/tracker"), {
      method: 'POST',
      headers: {
        "Authorization": "Bearer ".concat(localStorage.accessToken)
      },
...
var _default = new TrackerAPI();

exports.default = _default;
},{"./App":"App.js","./Auth":"Auth.js","./Toast":"Toast.js"}],"views/pages/tracker.js":[function(require,module,exports) {
"use strict";
...
var _TrackerAPI = _interopRequireDefault(require("./../../TrackerAPI"));
...
class TrackerView {
  ...
  async getTrackerEntries() {
    try {
      this.trackerEntries = await _TrackerAPI.default.getTrackerEntries();
...
var _default = new TrackerView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../TrackerAPI":"TrackerAPI.js","./../../Toast":"Toast.js"}],"views/pages/trackerEntry.js":[function(require,module,exports) {
"use strict";
...
class TrackerEntryView {
  ...
  async newTrackerSubmitHandler(e) {
    ...
    try {
      await _TrackerAPI.default.newTrackerEntry(formData);

      _Toast.default.show('Entry Added');

      submitBtn.removeAttribute('loading'); // reset form and clear text and textarea inputs
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject2(), () => (0, _Router.gotoRoute)('/'), this.newTrackerSubmitHandler, _Auth.default.currentUser._id, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase, _App.default.apiBase);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new TrackerEntryView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../TrackerAPI":"TrackerAPI.js","./../../Toast":"Toast.js"}],"views/pages/newBlog.js":[function(require,module,exports) {
"use strict";
...
class newBlogView {
  ...
  async newBlogSubmitHandler(e) {
    ...
    try {
      await _BlogAPI.default.newBlog(formData);

      _Toast.default.show('Blog Added');

      submitBtn.removeAttribute('loading'); // reset form and clear text and textarea inputs

      const textInputs = document.querySelectorAll('sl-input, sl-textarea');
      if (textInputs) textInputs.forEach(textInput => textInput.value = null); // reset file input
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject(), JSON.stringify(_Auth.default.currentUser), this.newBlogSubmitHandler, _Auth.default.currentUser._id);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }

}

var _default = new newBlogView();

exports.default = _default;
},{"./../../App":"App.js","lit-html":"../node_modules/lit-html/lit-html.js","./../../Router":"Router.js","./../../Auth":"Auth.js","./../../Utils":"Utils.js","./../../BlogAPI":"BlogAPI.js","../../Toast":"Toast.js"}],"Router.js":[function(require,module,exports) {
"use strict";
...
var _eatBlog = _interopRequireDefault(require("./views/pages/eatBlog"));

var _mindBlog = _interopRequireDefault(require("./views/pages/mindBlog"));

var _moveBlog = _interopRequireDefault(require("./views/pages/moveBlog"));

var _savedList = _interopRequireDefault(require("./views/pages/savedList"));

var _tracker = _interopRequireDefault(require("./views/pages/tracker"));

var _trackerEntry = _interopRequireDefault(require("./views/pages/trackerEntry"));

var _newBlog = _interopRequireDefault(require("./views/pages/newBlog"));
...
const routes = {
  ...
  '/eatBlog': _eatBlog.default,
  '/mindBlog': _mindBlog.default,
  '/moveBlog': _moveBlog.default,
  '/savedList': _savedList.default,
  '/tracker': _tracker.default,
  '/trackerEntry': _trackerEntry.default,
  '/newBlog': _newBlog.default
};
...
},{"./views/pages/dashboard":"views/pages/dashboard.js","./views/pages/404":"views/pages/404.js","./views/pages/signin":"views/pages/signin.js","./views/pages/signup":"views/pages/signup.js","./views/pages/profile":"views/pages/profile.js","./views/pages/editProfile":"views/pages/editProfile.js","./views/pages/about":"views/pages/about.js","./views/pages/eatBlog":"views/pages/eatBlog.js","./views/pages/mindBlog":"views/pages/mindBlog.js","./views/pages/moveBlog":"views/pages/moveBlog.js","./views/pages/savedList":"views/pages/savedList.js","./views/pages/tracker":"views/pages/tracker.js","./views/pages/trackerEntry":"views/pages/trackerEntry.js","./views/pages/newBlog":"views/pages/newBlog.js"}],"App.js":[function(require,module,exports) {
"use strict";
...
function _templateObject4() {
  const data = _taggedTemplateLiteral(["\n          <a href=\"/newBlog\" @click=\"", "\">New Blog</a>\n          "]);
...
customElements.define('va-blog', class Blog extends _litElement.LitElement {
  constructor() {
    super();
  }
  ...
  async saveBlogsHandler() {
    try {
      await _UserAPI.default.addSavedBlogs(this.id);

      _Toast.default.show('Blog added to Saved List');
    } catch (err) {
      _Toast.default.show(err, 'error');
    }
  }
...
},{"@polymer/lit-element":"../node_modules/@polymer/lit-element/lit-element.js","lit-html":"../node_modules/lit-html/lit-html.js","./../App":"App.js","./../UserAPI":"UserAPI.js","./../Toast":"Toast.js"}],"components/va-tracker.js":[function(require,module,exports) {
"use strict";
...
customElements.define('va-tracker', class Tracker extends _litElement.LitElement {
  constructor() {
    super();
  }
...
require("./components/va-blog");

require("./components/va-tracker");
...
},{"./App.js":"App.js","./components/va-app-header":"components/va-app-header.js","./components/va-blog":"components/va-blog.js","./components/va-tracker":"components/va-tracker.js","./scss/master.scss":"scss/master.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
