  ...
  render(){    
    ...
    <header class="app-header">
      ...
      <nav class="app-top-nav">
        ...
        ${this.user.accessLevel == 2 ? html`
          <a href="/newBlog" @click="${anchorRoute}">New Blog</a>
          ` : ``}
    ...
    <sl-drawer class="app-side-menu page-content" placement="left">
      ...
      <nav class="app-side-menu-items">
        ...
        <a href="/savedList" @click="${this.menuClick}">Saved List</a>
        <a href="/profile" @click="${this.menuClick}">Profile</a>
        <h2>Learn</h2>
        ${this.user.accessLevel == 2 ? html`
          <a href="/newBlog" @click="${this.menuClick}">New Blog</a>
          ` : ``}
        <a href="/eatBlog" @click="${this.menuClick}">Eat</a>
        <a href="/mindBlog" @click="${this.menuClick}">Mind</a>
        <a href="/moveBlog" @click="${this.menuClick}">Move</a>
        <h2>More</h2>
